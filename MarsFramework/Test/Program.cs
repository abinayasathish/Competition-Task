    ...
    public class Program
    {
        ...
        class User : Global.Base
        {
            ...
            public void AddShareSkillService()
            {
                ...
                ((ITakesScreenshot)GlobalDefinitions.driver).GetScreenshot().SaveAsFile("./MarsFramework/TestReports/Screenshots/Screenshot-entershareskill.png", ScreenshotImageFormat.Png);
